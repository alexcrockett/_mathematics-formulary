...
Here we had a cursory review of three functions with complex behaviors, all of which requiring significantly more depth. However, that will come. For now let us be content in understand first what a quadratic function is an does and secondly, the impact of a leading power on the functions that contain them.
